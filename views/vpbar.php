            ...
            <form name="frm1" action="home.php?pg=<?= $pg; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-group" for="nompropi">Nombre Del Propietario </label>
                            <input type="text" class="form-control restricted" name="nompropi" id="nompropi"
                                   value="<?= $_SESSION['nompropi'] ?? ''; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-group" for="dircbar">Dirección </label>
                            <input type="text" class="form-control restricted" name="dircbar" id="dircbar"
                                   value="<?= $_SESSION['dircbar'] ?? ''; ?>" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-group" for="horbar">Horario </label>
