...
<?php
require_once('controllers/cemgan.php');

// Establecer el idioma español y la zona horaria para Bogotá
            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    if (!empty($gananciasAnio)) {
                        ...
                        echo "<tr><td colspan='2' class='text-center'>No hay ventas en el año vigente</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
