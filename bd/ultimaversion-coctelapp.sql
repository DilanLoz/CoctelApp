...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2024 a las 17:06:48
...
(1002, 'Bares', 'views/vusbares.php', 1, 1, 'Bares', '', 'Vista bares'),
(1004, 'Cócteles', 'views/vuscoct.php', 1, 2, 'Cócteles', NULL, 'Vista Cocteles'),
(1005, 'Vinos', 'views/vusvino.php', 1, 3, 'Vinos', NULL, 'Vista Vinos'),
(1006, 'Licores', 'views/vuslicor.php', 1, 4, 'Licores', NULL, 'Vista Licores'),
(1007, '', 'views/vuscarcom.php', 1, 7, 'Carrito', 'fa-solid fa-cart-shopping', 'Carrito de compras'),
(1008, '', 'views/vushipe.php', 1, 5, 'Historial', 'fa-solid fa-clipboard-list', 'Historial de pedidos'),
(1009, NULL, 'views/vpusu.php', 1, 6, 'Perfil', 'fa-regular fa-user', 'Perfil usuario'),
(1010, 'Productos de bares', 'views/vusbarxprod.php', 2, NULL, NULL, NULL, ''),
(2001, 'Pedidos', 'views/vexbpedproc.php', 1, 1, 'Pedidos', NULL, 'Pedidos en proceso'),
(2002, 'Ganancias', 'views/vemgan.php', 1, 2, 'Ganancias', NULL, 'Ganancias '),
(2003, '', 'views/vemhipe.php', 1, 3, 'Historial', 'fa-solid fa-clipboard-list', 'Historial de pedidos'),
(2004, '', 'views/vpemp.php', 1, 4, 'Perfil', 'fa-regular fa-user', 'Perfil empleado'),
(3001, 'Pedidos', 'views/vexbpedproc.php', 1, 1, 'Pedidos', NULL, 'Pedidos en proceso'),
(3002, 'Ganancias', 'views/vemgan.php', 1, 2, 'Ganancias', '', 'Ganancias por pedidos'),
(3003, 'Crear Productos', 'views/vbarxprod.php', 1, 3, 'Crear Productos', NULL, 'CRUD Producto'),
(3004, 'Crear Empleados', 'views/vbarxem.php', 1, 4, 'Crear Empleados', NULL, 'CRUD Empleado'),
(3005, '', 'views/vbarhipe.php', 1, 5, 'Historial', 'fa-solid fa-clipboard-list', 'Historial de pedidos'),
(3006, '', 'views/vpbar.php', 1, 6, 'Perfil', 'fa-regular fa-user', 'Perfil bar'),
(4010, '', 'admin/views/vdomval.php', 1, 1, 'Dominio y valor', 'fa-solid fa-gears', 'Dominio y valor '),
...
--
ALTER TABLE `pagina`
  MODIFY `idpag` int(5) NOT NULL AUTO_INCREMENT COMMENT 'id de pagina', AUTO_INCREMENT=4111;
