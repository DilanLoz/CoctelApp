...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2024 a las 20:05:10
...
INSERT INTO `metpago` (`idmetpago`, `nommetpago`, `nomtitu`, `cvv`, `fecvenci`, `numtarj`, `idusu`) VALUES
(1, 'TARJETA DEBITO', NULL, NULL, NULL, NULL, NULL),
(2, 'PSE', NULL, NULL, NULL, NULL, NULL),
(3, 'CONTRA ENTREGA', NULL, NULL, NULL, NULL, NULL),
(4, 'Tarjeta Debito', 'David Casas', 232, '2028-12-07', 497382012, 1);
...
INSERT INTO `pedido` (`idpedido`, `idcarrito`, `idmetpago`, `fecha_pedido`, `estado`, `total`, `idusu`) VALUES
(100110, NULL, 4, '2024-12-02', 'Pendiente', 200000.00, 2001);
...
--
ALTER TABLE `detpedido`
  MODIFY `iddetpedido` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109302;
...
--
ALTER TABLE `metpago`
  MODIFY `idmetpago` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `pedido`
  MODIFY `idpedido` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100111;
