...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2025 a las 16:26:38
...
INSERT INTO `detpedido` (`iddetpedido`, `idpedido`, `idprod`, `cantidad`, `total`, `idusu`) VALUES
(109301, 100110, 36, 20, 200000, 2003);
...
INSERT INTO `pedido` (`idpedido`, `idcarrito`, `fecha_pedido`, `estado`, `total`, `idusu`, `idfactura`, `estado_pago`, `metodo_pago`) VALUES
(100110, 10, '2024-12-02', '', 200000, 2001, NULL, 'Pendiente', 'Efectivo');
